...
function Ratings() {
    ...
    return (
        <div id="rating">
            <button onClick={() => resetRating(1)}><Star clicked={clicked1}/></button>
            <button onClick={() => resetRating(2)}><Star clicked={clicked2}/></button>
            <button onClick={() => resetRating(3)}><Star clicked={clicked3}/></button>
            <button onClick={() => resetRating(4)}><Star clicked={clicked4}/></button>
            <button onClick={() => resetRating(5)}><Star clicked={clicked5}/></button>
        </div>
    )
}
